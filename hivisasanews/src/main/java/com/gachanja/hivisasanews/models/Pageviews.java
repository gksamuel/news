...
public class Pageviews implements Serializable {
    ...
    public Pageviews(Integer pageviewid, String ipaddress, Date datecreated, Articles articleid) {
        this.pageviewid = pageviewid;
    ...
    public String toString() {
        return "com.gachanja.hivisasanews.models.Pageviews[ pageviewid=" + pageviewid + " ]";
    }
